  ...
  return (
    <div className="container text-center">
      <div className="row rows">
        <div className="col-6"> <input type="text" placeholder="Enter the todo here" onChange={(event)=>{handleOnChangeItem(event);setValue(event.target.value);}} value={clickedAddBtn=="false" ? value:""}></input></div>
